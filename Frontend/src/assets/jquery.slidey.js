    ...
    $.slidey = function(el, options) {
        ...
        base.constructLayout = function() {
            ...
            if (base.options.showList) {
                domdocument += "<div class='slidey-row row'><div class='slidey-image col-lr-8'><div class='slidey-overlay'>";
            } else {
                domdocument += "<div class='slidey-row row'><div class='slidey-image col-lr-12'><div class='slidey-overlay'>";
            }
            ...
            domdocument += "</div></div><div class='slidey-list col-lr-4'></div></div>";
